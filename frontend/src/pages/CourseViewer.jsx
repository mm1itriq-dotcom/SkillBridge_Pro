...
export default function CourseViewer() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
      <div style={{ padding: '1.5rem 3.75rem', borderBottom: '0.062rem solid var(--border-color)', display: 'flex', alignItems: 'center', gap: '1.5rem', backgroundColor: 'var(--course-bg)' }}>
        <button onClick={handleBack} style={{ background: 'none', border: 'none', color: 'var(--text-muted)', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '0.5rem', fontSize: '1rem' }}>
      ...
      <div style={{ display: 'flex', flex: 1, overflow: 'hidden' }}>
        {/* Video Player Area */}
        <div style={{ flex: 3, padding: '2.5rem 3.75rem', overflowY: 'auto', backgroundColor: 'var(--bg-color)' }}>
          <div style={{ width: '100%', aspectRatio: '16/9', backgroundColor: 'black', borderRadius: '1rem', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', position: 'relative', overflow: 'hidden', boxShadow: 'var(--shadow-xl)' }}>
            <div style={{ textAlign: 'center' }}>
              <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={{ opacity: 0.8, marginBottom: '1rem' }}><circle cx="12" cy="12" r="10"></circle><polygon points="10 8 16 12 10 16 10 8"></polygon></svg>
              <h3 style={{ margin: 0, fontSize: '1.5rem', fontWeight: '500' }}>Module 1: Introduction</h3>
            </div>
          </div>
          
          <div style={{ marginTop: '2rem' }}>
            <h1 style={{ fontSize: '2rem', marginBottom: '1rem' }}>Module 1: Introduction</h1>
        ...
        <div style={{ flex: 1, minWidth: '21.875rem', backgroundColor: 'var(--course-bg)', borderLeft: '0.062rem solid var(--border-color)', overflowY: 'auto' }}>
          <div style={{ padding: '1.5rem', borderBottom: '0.062rem solid var(--border-color)' }}>
            <h3 style={{ margin: 0, fontSize: '1.1rem' }}>Course Content</h3>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginTop: '0.75rem' }}>
              <div style={{ flex: 1, height: '0.375rem', backgroundColor: 'var(--border-color)', borderRadius: '6.188rem', overflow: 'hidden' }}>
          ...
          <div style={{ padding: '1rem 1.5rem', display: 'flex', alignItems: 'center', gap: '1rem', cursor: 'pointer', backgroundColor: 'var(--sidebar-hover)' }}>
            ...
            <div>
              <div style={{ fontWeight: '600', color: 'var(--text-main)', marginBottom: '0.25rem' }}>1. Introduction</div>
          ...
          <div style={{ padding: '1rem 1.5rem', display: 'flex', alignItems: 'center', gap: '1rem', cursor: 'pointer' }}>
            ...
            <div>
              <div style={{ fontWeight: '500', color: 'var(--text-muted)', marginBottom: '0.25rem' }}>2. Core Concepts</div>
          ...
          <div style={{ padding: '1rem 1.5rem', display: 'flex', alignItems: 'center', gap: '1rem', cursor: 'pointer' }}>
            ...
            <div>
              <div style={{ fontWeight: '500', color: 'var(--text-muted)', marginBottom: '0.25rem' }}>3. Advanced Implementation</div>
